...
<body>
    ...
    <form action="post-request" method="post">
        ...
        <input type="checkbox" name="hobbies" id="music2" value="music"/><label for="movie">음악</label>
        <input type="checkbox" name="hobbies" id="sleep2" value="sleep"/><label for="movie">수면</label>
        <button type="submit">전송하기</button>
    </form>
</body>
</html>