...
public class QueryStringTestServlet extends HttpServlet {
    ...
    * httpServlet을 상속받아 오버라이딩한 현재 클래스의 doGet() method가 동적 바인딩에 의해 호출된다.
    * ==================================================================================================================
    * Service로 부터 전달받은 httpServletRequest는 요청시 전달한 값을 getParameter() method로 추출할 수 있다 .
    * 이때 인자로 input 태그에 지정한 name 속성의 값을 문자열 형태로 전달해주면 된다.
